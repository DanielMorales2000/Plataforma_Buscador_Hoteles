        ...
        <div class="container">
            <div class="row">
                <div class=" col-md-6 offset-md-3">
                    <div class="address">
                        <form method="POST" action="../backend/Crud_Actualizar_Empleado">
                            <div class="row">
                            <?php	
                                if(isset($_GET['editar'])){
                                    $_SESSION['emp_id'] = $_GET['editar'];
                                    $empleado_id = $_SESSION['emp_id'];

                                    $consulta = "EXEC	[dbo].[PA_DATOS_EMPLEADO]
                                    @ID_PERSONA ='$empleado_id'";
                                    $ejecutar = sqlsrv_query($conn, $consulta);
                                    $fila = sqlsrv_fetch_array($ejecutar);

                                    $NOMBRE_SUB_CUENTA = $fila['NOMBRE_SUB_CUENTA'];
                                    $NOMBRE = $fila['NOMBRE'];
                            ...
                            ?>
                                <div class="col-sm-12">
                                    <label>Nombre Subcuenta</label>
                                    <input class="contactus" type="text" name="nombre_subcta" placeholder="Inserte el nombre de la Subcuenta" required=true value="<?php echo $NOMBRE_SUB_CUENTA; ?>" maxlength="40">
                                </div>
                                <div class="col-sm-12">
                                    <label>Nombre</label>
                                    <input class="contactus" type="text" name="noombre" placeholder="Inserte el Nombre" required=true value="<?php echo $NOMBRE; ?>" maxlength="40">
                                </div>
                                <div class="col-sm-12">
                                    <label>Apellido</label>
                                    <input class="contactus" type="text" name="Apellidoo" placeholder="Inserte el Apellido" required=true value="<?php echo $APELLIDO; ?>" maxlength="40">
                                </div>
                                <div class="col-sm-12">
                                    <label>Correo</label>
                                    <input class="contactus" type="email" name="corr" placeholder="Inserte el Correo" required=true value="<?php echo $CORREO; ?>" maxlength="50">
                                </div>
                                <div class="col-sm-12">
                                    <label>Direccion</label>
                                    <input class="contactus" type="text" name="dircn" placeholder="Inserte la Direccion" required=true value="<?php echo $DIRECCION; ?>" maxlength="50">
                                </div>
                                <div class="col-sm-12">
                                    <label>Telefono</label>
                                    <input class="contactus" type="text" name="telefno" placeholder="Inserte el Telefono" required=true value="<?php echo $TELEFONO; ?>" maxlength="20">
                                </div>
                                <div class="form-group">				
                                    <input type="submit" name="actualizaremple" class="send" value="ACTUALIZAR DATOS"><br />
                                </div>
                        </form>
                        <form method="POST" action="../backend/crud_actualizar_empleado">
                            <div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <input class="contactus" type="password" name="clav" placeholder="Inserte su Clave" minlength="8" maxlength="30" required=true>
                            </div>
                            <div class="col-sm-12">
                                <label>Ingrese nuevamente su clave</label>
                                <input class="contactus" type="password" name="clav1" placeholder="Ingrese nuevamente su clave" minlength="8"  maxlength="30" required=true>
                            </div>
                            <div class="form-group">				
                                <input type="submit" name="actualizaclaveemp" class="send" value="ACTUALIZAR CLAVE"><br />
                            </div>
                        </form>
                    </div>
                </div>
